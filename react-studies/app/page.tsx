...
export default function HomePage() {
  const logo = require('../src/images/renova-icon.png').default;
  const login = require('../src/images/img-login.png').default;  
  const fiscal = require('../src/images/FiscalMind.png').default;
  return(
      <div className="w-screen h-screen bg-linear-to-br from-white to-teal-700 flex">
        <div className="p-5">
            <img src={logo.src} className="w-10 h-8" alt="Renova icon"/>
          <div className="left-5 space-y-4 mt-10">
            <Splash>Gestão financeira <br /><b className="text-teal-400">segura</b> e dados <br />com <b className="text-teal-400">inteligência</b></Splash>
          </div>
          <div>
            <img src={login.src} className="w-125 left-10 z-50 absolute" alt="Login illustration"/>
          </div>
        </div>
        ...
        <div className="h-full w-4/6 absolute right-0 bg-white rounded-xl">
          ...
          <h2 className="text-black mt-9 ml-25">Acesse sua conta para continuar</h2>
